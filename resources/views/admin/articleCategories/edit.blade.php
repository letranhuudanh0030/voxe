...
<section id="nb-create-article-category">
    <div class="container-fluid mt-3">
        <form action="{{ route('catalogue.update', $articleCategory->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-9">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <select size="5" class="form-control" name="parent_id">
                                        ...
                                        @if ($articleCategories)
                                            {{ showCategories($articleCategories, $articleCategory) }}
                                        @else
                                ...
                                <div class="col-sm-10 mb-3">
                                    <select size="5" class="form-control" name="page_type">
                                        @foreach (config('variables.page_type') as $key => $item)
                                            <option value="{{ $key }}" @if ($key == $articleCategory->page_type )
                                            selected
                                            @endif>{{ $item }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="category_image" name="cate_image" readonly>
                                    ...
                                    <br>
                                    <img src="{{ asset($articleCategory->cate_image) }}" alt="" class="img-fluid cate-img" width="100px" height="100px">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3">
                                    ...
                                    <br>
                                    <img src="{{ asset($articleCategory->avatar_image) }}" alt="" class="img-fluid avatar-img" width="100px" height="100px">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <textarea id="short-desc" cols="30" rows="10" class="form-control" name="short_desc">{{ $articleCategory->short_desc }}</textarea>
                        ...
                        <div class="card-body">
                                ...
                                <div>
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="publish" value="0" @if (!$articleCategory->publish)
                                                checked
                                    ...
                                    <div class="form-check-inline mb-1 ">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="publish" value="1" @if ($articleCategory->publish)
                                            checked
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div>
                                    ...
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="highlight" value="0" @if (!$articleCategory->highlight)
                                            checked
                                        @endif><span class="bg-secondary nb-check text-white">Không</span>
                                        </label>
                                    </div>
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="highlight" value="1" @if ($articleCategory->highlight)
                                            checked
                                        @endif><span class="bg-success text-white nb-check">Có</span>
                                        </label>
                                    </div>
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div>
                                    ...
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="link" value="0" @if (!$articleCategory->link)
                                            checked
                                        @endif><span class="bg-secondary nb-check text-white">Không</span>
                                        </label>
                                    </div>
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="link" value="1" @if ($articleCategory->link)
                                            checked
                                        @endif><span class="bg-success text-white nb-check">Có</span>
                                        </label>
                                    </div>
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div>
                                    ...
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="one_article" value="0" @if (!$articleCategory->one_article)
                                            checked
                                        @endif><span class="bg-secondary nb-check text-white">Không</span>
                                        </label>
                                    </div>
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="one_article" value="1" @if ($articleCategory->one_article)
                                            checked
                                        @endif><span class="bg-success text-white nb-check">Có</span>
                                        </label>
                                    </div>
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div>
                                    ...
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="unlink" value="0" @if (!$articleCategory->un_link)
                                            checked
                                        @endif><span class="bg-secondary nb-check text-white">Không</span>
                                        </label>
                                    </div>
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="unlink" value="1" @if ($articleCategory->un_link)
                                            checked
                                        @endif><span class="bg-success text-white nb-check">Có</span>
                                        </label>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tiêu đề danh mục" name="meta_title" value="{{ $articleCategory->meta_title }}">
                            </div>
                            <div class="form-group">
                                <label for="">Slug:</label>
                                <input type="text" class="form-control" placeholder="Nhập link slug (nếu có)" name="slug" value="{{ $articleCategory->slug }}">
                            </div>
                            <div class="form-group">
                                <label for="">Keywords: 70 kí tự</label>
                                <input type="text" class="form-control" placeholder="Nhập các từ khó cho SEO" name="meta_keywords" value="{{ $articleCategory->meta_keyword }}">
                            </div>
                            <div class="form-group">
                                <label for="">Description: 160 kí tự</label>
                                <textarea id="" cols="30" rows="5" class="form-control" name="meta_description">{{ $articleCategory->meta_desc }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
