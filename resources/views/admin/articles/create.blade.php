                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="checkbox" name="check_question" id="" value="1"> Hiển thị câu hỏi thường gặp trong bài viết
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <textarea id="content" cols="30" rows="10" class="form-control" name="content">{{ old('content') }}</textarea>
                                    @error('content')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
