                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <span class="text-small text-gray help-block-none">Nhập tên đối tác.</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="type_id" id="" class="form-control">
                                        @foreach (config('variables.type_partner') as $key => $type)
                                            <option value="{{ $key }}" {{ $partner->type_id == $key ? "selected" : "" }}>{{ $type }}</option>
                                        @endforeach
                                    </select>
                                    <span class="text-small text-gray help-block-none">Nhập tên đối tác.</span>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3">
                                    ...
                                    <br>
                                    <img src="{{ asset($partner->avatar_image) }}" alt="" class="img-fluid avatar-img" width="100px" height="100px">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label">Link quảng cáo:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="link" value="{{ $partner->link }}">
                                    <span class="text-small text-gray help-block-none">Nhập link quảng cáo (nếu có).</span>
                                </div>
                            </div>
                                ...
                                <div>
                                    <div class="form-check-inline mb-1">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="publish" value="0" @if (!$partner->publish)
                                                checked
                                            @endif>
                                    ...
                                    <div class="form-check-inline mb-1 ">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input " name="publish" value="1" @if ($partner->publish)
                                            checked
                                        @endif>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tiêu đề sản phẩm" name="meta_title" value="{{ $partner->meta_title }}">
                            </div>
                            <div class="form-group">
                                <label for="">Keywords: 70 kí tự</label>
                                <input type="text" class="form-control" placeholder="Nhập các từ khóa cho SEO" name="meta_keywords" value="{{ $partner->meta_keyword }}" >
                            </div>
                            <div class="form-group">
                                <label for="">Description: 160 kí tự</label>
                                <textarea id="" cols="30" rows="5" class="form-control" name="meta_description">{{ $partner->meta_desc }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
