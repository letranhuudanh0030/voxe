                ...
                <div class="col-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label">Quảng cáo :</label>
                                <div class="col-sm-10 mb-3">
                                    <textarea id="content" cols="30" rows="10" class="form-control" name="ad_content">{{ old('ad_content') }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tiêu đề danh mục sản phẩm" name="meta_title" value="{{ old('meta_title') }}">
                            </div>
                            <div class="form-group">
