                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-content mt-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 mb-3">
                                        <input type="text" name="title" id="title" class="form-control" value="{{ $estate->title }}">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <select name="region_code" id="region" class="form-control">
                                                @foreach (config('variables.region') as $key => $region)
                                                    <option value="{{ $key }}" {{ $estate->region_code == $key ? "selected" : "" }}>{{ $region }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-3">
                                            <label for="">Thành phố:</label>
                                            <select name="city_code" id="city" class="form-control" data-city-id="{{ $estate->city_code }}">
                                                <option value="">-- Chọn thành phố --</option>
                                            </select>
                                        </div>
                                        <div class="col-3">
                                            <label for="">Quận/Huyện:</label>
                                            <select name="district_code" id="district" class="form-control" data-district-id="{{ $estate->district_code }}">
                                                <option value="">-- Chọn quận/huyện --</option>
                                            </select>
                                        </div>
                                        <div class="col-3">
                                            <label for="0">Phường/Xã:</label>
                                            <select name="ward_code" id="ward" class="form-control" data-ward-id="{{ $estate->ward_code }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="avatar_image" name="avatar_image" readonly value="{{ $estate->avatar_image }}">
                                    ...
                                    <br>
                                    <img src="{{ asset($estate->avatar_image) }}" alt="{{ $estate->slug }}" class="img-fluid avatar-img" width="100px" height="100px">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3">
                                    ...
                                    <div class="product-imgs">
                                        @foreach (explode(',', $estate->images) as $img)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <textarea name="contact" id="contact" class="form-control config_content">{{ $estate->contact }}</textarea>
                                ...
                                <div class="col-sm-10 mb-3">
                                    <select class="form-control choose-estate" name="type_spec">
                                        @forelse (config('variables.choose_form_estate') as $key => $item)
                                            <option value="{{ $key }}" {{ $estate->type_spec == $key ? "selected" : "" }}>{{ $item }}</option>
                                        @empty
                                ...
                                <div class="form-content mt-4">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <select size="5" class="form-control" name="product_category_id" id="cate_dcn">
                                                ...
                                                @if ($productCategories)
                                                    {{ showCategories($productCategories,null, $cate_dcn->id, '', $estate->product_category_id) }}
                                                @else
                                                    There are no subcategories
                                                @endif
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="row">
                                                <div class="col-8">
                                                    <input type="number" class="form-control price" name="price" value="{{ number_format($estate->price) }}" placeholder="Nhập giá tiền.">
                                                    ...
                                                    <input type="text" class="form-control price-format" name="price_format" value="{{ number_format($estate->price) }}" placeholder="0" disabled>
                                                    ...
                                                    <div class="form-group">
                                                      <select class="form-control" name="currency" id="price_unit">
                                                        ...
                                                        @foreach (config('variables.price_unit') as $key => $unit)
                                                            <option value="{{ $key }}" {{ $estate->currency == $key ? "selected" : "" }}>{{ $unit }}</option>
                                                        @endforeach
                                                      </select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="row">
                                                <div class="col-8">
                                                    <input type="number" class="form-control" name="acreage" value="{{ $estate->acreage }}" placeholder="Nhập diện tích.">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <select class="form-control" name="unit_area" id="acreage_unit">
                                                        ...
                                                        @foreach (config('variables.acreage_unit') as $key => $unit)
                                                            <option value="{{ $key }}" {{ $estate->unit_area == $key ? "selected" : "" }}>{{ $unit }}</option>
                                                        @endforeach
                                                      </select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <textarea name="description" id="description" class="form-control config_content">{{ $estate->description }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <textarea name="condition" id="condition" class="form-control config_content">{{ $estate->condition }}</textarea>
                            ...
                            <div class="form-nxnk" style="display: none">
                                ...
                                <div class="form-content mt-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <select size="5" class="form-control" name="product_category_id" id="cate_nxnk">
                                                ...
                                                @if ($productCategories)
                                                    {{ showCategories($productCategories,null, $cate_nxnk->id, '', $estate->product_category_id) }}
                                                @else
                                                    There are no subcategories
                                                @endif
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <textarea name="functional_subdivision" id="functional_subdivision" class="form-control config_content">{{ $estate->functional_subdivision }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <textarea name="infrastructure" id="infrastructure" class="form-control config_content">{{ $estate->infrastructure }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <textarea name="investment_costs" id="investment_costs" class="form-control config_content">{{ $estate->investment_costs }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <textarea name="career" id="career" class="form-control config_content">{{ $estate->career }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <textarea name="incentives" id="incentives" class="form-control config_content">{{ $estate->incentives }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mb-3">
                                            <textarea name="suport" id="suport" class="form-control config_content">{{ $estate->suport }}</textarea>
...
<script>
    $(function(){
       ...
       var selectType = $('.choose-estate').val()
       if(selectType == 'f-dat-cong-nghiep'){
            $('.form-dcn').css('display', 'block')
            $('.form-nxnk').css('display', 'none')
            $('#cate_dcn').prop('disabled', false);
            $('#cate_nxnk').prop('disabled', true);
        } else if(selectType == 'f-nha-xuong') {
            $('.form-dcn').css('display', 'none')
            $('.form-nxnk').css('display', 'block')
            $('#cate_dcn').prop('disabled', true);
            $('#cate_nxnk').prop('disabled', false);
