        ...
        <div class="card">
            ...
            {{-- <form action=""> --}}
                <div class="card-body">
                    <div class="form-lang">
                        @if ($article)
                            @foreach ($article->language as $key => $item)
                            <div class="card language language-edit-{{ $key }}">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="name_lang">Tên bài viết:</label>
                                        <input type="text" id="name_lang" name="name_lang[]" class="form-control" placeholder="Nhập tên bài viết ngôn ngữ mới" value="{{ $item->pivot->title }}">
                                    </div>
                                    <div class="form-group">
...
<script>
    ...
    $('.add-lang').click(function(){
        ...
        form += OpenFormGroup
        form += '<label for="name_lang'+ index +'">Tên bài viết:</label>'
        form += '<input type="text" id="name_lang'+ index +'" name="name_lang[]" class="form-control" placeholder="Nhập tên bài viết ngôn ngữ mới">'
        form += CloseDiv
        form += OpenFormGroup
        ...
        form += CloseDiv
        form += OpenFormGroup
        form += '<label for="content_lang'+ index +'">Nội dung:</label>'
